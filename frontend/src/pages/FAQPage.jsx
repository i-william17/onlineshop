    ...
    <div className={`${styles.section} my-8`}>
      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@myecommercestore.com, or by calling us at (+254) 7********
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          >
            <span className="text-lg font-medium text-gray-900">
              Do you offer deliveries to all parts of the country?
            </span>
            {activeTab === 6 ? (
              <svg
                className="h-6 w-6 text-gray-500"
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we offer shipping to all parts of the country.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept Visa, Mastercard, Paypal and M-pesa payment method. Also we have
                Cash on Delivery.
              </p>
            </div>
          )}
